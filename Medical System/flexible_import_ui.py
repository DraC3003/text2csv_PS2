...
class FlexibleDataImportFrame:
    ...
    def setup_ui(self):
        ...
        # Title
        title_label = ttk.Label(main_frame, text="Flexible CSV Data Import", 
                               font=('Arial', 16, 'bold'))
        title_label.pack(pady=(0, 20))
        
        # Instructions
        instructions = ttk.Label(main_frame, 
                               text="Import CSV files from medical devices with automatic column detection",
                               font=('Arial', 10))
        ...
        field_combo = ttk.Combobox(manual_controls, textvariable=self.field_var,
                                  values=['patient_id', 'age', 'gender', 'test_name', 
                                         'test_value', 'test_date', 'first_name', 'last_name',
                                         'unit', 'lab_technician', 'notes'],
                                  width=15, state='readonly')
